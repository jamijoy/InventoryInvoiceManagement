...
<head>
        ...
        <title>Blu Fashion BD - Product Addition</title>
         ...
         <div class="cardbox">
          ...
          <div class="cardbox-heading">
           ...
           <div class="dropdown pull-right">
            ...
            <div class="dropdown-menu dropdown-scale dropdown-menu-right" role="menu" style="position: absolute; transform: translate3d(-136px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
	         <a class="dropdown-item" href="#">Previous Products</a>
           ...
           <div class="media m-0">
            ...
            <div class="media-body">
             <p class="m-0">Add A Product</p>
			 <small><span>Mrchent ID : 10098</span></small>
            </div>
           </div><!--/ media -->
          </div><!--/ cardbox-heading -->
		  ...
		  <div class="cardbox-item">
			<div style="margin-left:25px;">
					...
					<lable class="col-sm">Store Name :</lable>
						<div class="col-sm">
					...
					<div class="col-6 col-md-4">
					<lable class="col-sm">Product Category :</lable>
						<div class="col-sm">
					<select id="considerStatus">
					...
					<div class="col-6 col-md-4">
					<div class="col-sm-12" >
						<lable class="col-sm">Product Reference Number :</lable>
						<div class="col-sm">
		    ...
		    <div style="margin-left:25px;">
				<div class="row">
				  ...
				  <div class="col-8 col-sm-6">
					<div class="row">
				  <div class="col-sm-6" >
						<lable class="col-sm">Product Name </lable>
						<div class="col-sm">
					 <input type="text" id="carry_fwd_status_edit">
						</div>
					</div>
					...
					<div class="row">
					<div class="col-sm-6" >
						<lable class="col-sm">Product Unit Price </lable>
						<div class="col-sm">
					 <input type="text" id="carry_fwd_status_edit">
						</div>
					</div>
					...
					<div class="row">
					<div class="col-sm-6">
						<label for="consider_Status">Product Details :</label>
				  ...
				  <div class="col-4 col-sm-6" style="margin-left: 0px;left: 20px;"> <!-- right Side -->
					...
					<lable class="col-sm">Product Image ( If Any): </lable>
						<div class="col-6">
					<input class="kafe kafe-btn-mint-small" type="file" style="padding:10px;border-radius:10px;" />	
					</div>
				...
				<div class="row">
					<div class="col-sm-6" >
						<lable class="col-sm">Sell Price :  </lable>
				...
				<div class="row">
					...
					<div class="col-sm-6" >
						<lable class="col-sm">Product Quantity :  </lable>
					...
					<button type="button" class="btn btn-primary btn-lg pull-right" onclick="window.location.replace('bf_home.html')" style="
					margin-right: 80px;">Add This Product</button><br/><br/>
