...
<head>
        ...
        <title>Blu Fashion BD - Home</title>
          ...
          <div class="cardbox-heading">
           ...
           <div class="dropdown pull-right">
            ...
            <div class="dropdown-menu dropdown-scale dropdown-menu-right" role="menu" style="position: absolute; transform: translate3d(-136px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
			 ...
			 <a class="dropdown-item" href="#">Bid Price</a>
			 <a class="dropdown-item" href="#">Take Invoice</a>
            </div>
           </div><!--/ dropdown -->
           <!-- END dropdown-->
           <div class="media m-0">
            ...
            <div class="media-body">
             <p class="m-0">Hair Straightener Brush I Kemei KM-HC111 Straem Spray LCD display</p>
			 <small><span>15/3/2020 08:50 PM, Hair Styling Tools</span></small>
            </div>
           </div><!--/ media -->
          </div><!--/ cardbox-heading -->
			   ...
			   <center>
				<Table style="width:97%;">
					...
					<tr>
						<td>
							<a href="#myModal">
							<img width="100px" height="80px" src="assets/img/posts/14.jpg" alt="MaterialImg">
						   </a> 
						</td>
						<td style="padding:20px;">
							Top Deals at Factory Price.Confidently Place Orders Online via Trade Assurance! Most Popular. 100% Refund. Quality Assured. Types: Apparel, Tools & Hardware, Home Appliance, Consumer Electronics, Jewelry and Watches, Furniture, Bags and Shoes.
						</td>
						<td>
							$ 25
						</td>
          ...
          <div class="col-md-4 modal-meta">
           <div class="modal-meta-top">
            ...
            <div class="img-poster clearfix">
             <a href="#"><img class="img-responsive img-circle" src="assets/img/users/2.jpg" alt="Image"/></a>
             <strong><a href="profile.html">UserName</a></strong>
             <span>Marchent ID : 10098 </span><br/>
            </div><!--/ img-poster -->
			  
            <ul class="img-comment-list">
             <li>
              <div class="comment-text">
               <strong><a href="#">Hair Straightener Brush I Kemei KM-HC111 Straem Spray LCD display</a></strong>
               <p>Hair Styling Tools, Hair Straightener</p> <span class="date sub-text">15/3/2020 08:50 PM</span>
              </div>
             </li><!--/ li -->
             <li>
			 <div class="comment-text">
               <strong><a href="#">Price and Description</a></strong>
               <p style="text-align:justify;">Top Deals at Factory Price.Confidently Place Orders Online via Trade Assurance! Most Popular. 100% Refund. Quality Assured. Types: Apparel, Tools & Hardware, Home Appliance, Consumer Electronics, Jewelry and Watches, Furniture, Bags and Shoes.</p> <span>$25</span>
              </div>
             </li><!--/ li -->
            ...
            <div class="modal-meta-bottom">
			 <ul>
			  <li>
			  <a class="kafe kafe-btn-mint-small" href="#">Bid Product</a>
              </li>				
             </ul>				
